    ...
    return (
        <>
            <div className="bg-white rounded-md flex flex-col items-center py-7 px-5 gap-4">
                ...
                <butto className="text-borderButtonColor cursor-pointer border-2 border-borderButtonColor rounded-md py-2 w-full flex justify-center font-semibold" >{infoButton}</butto>
                <span>O</span>
    ...
    return (
        <>
            <div className=" shadow-lg bg-white rounded-md flex flex-col items-center py-7 px-5 gap-4">
                ...
                <h3 className="text-2xl text-textColorTitle  font-bold ">{title}</h3>
                <h3 className="text-3xl text-textColorTitle font-bold">{price}</h3>
                <butto className="font-semibold bg-borderButtonColor cursor-pointer border-2 border-borderButtonColor rounded-md py-2 w-full flex justify-center text-white shadow-lg shadow-borderButtonColor " >{infoButton}</butto>
